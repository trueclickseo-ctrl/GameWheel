...
export const metadata = {
  title: "أدر عجلة القرارات الفورية | GameWheelClub العربية",
  description: "أدر عجلة القرارات العشوائية للحصول على اختيارات فورية غير متحيزة. مجاني، سريع، وعادل.",
};
    ...
    <div dir="rtl" className="font-sans">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <section className="mb-16">
          <WheelSpinner storageKey="gamewheelclub-ar-wheel" />
        </section>
      </main>
